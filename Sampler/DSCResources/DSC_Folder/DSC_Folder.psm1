...
$script:resourceHelperModulePath = Join-Path -Path $script:modulesFolderPath -ChildPath 'HelperSubmodule'
Import-Module -Name (Join-Path -Path $script:resourceHelperModulePath -ChildPath 'HelperSubmodule.psm1')

$script:localizedData = Get-LocalizedData -ResourceName 'DSC_Folder'
