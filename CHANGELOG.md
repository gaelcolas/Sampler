...
- It is not possible to specify module semantic version in the build.yml using
  the key `SemVer`, e.g. `SemVer: '99.0.0-preview1'`. This can be used if the
  preferred method of using GitVersion is not available ([issue #279](https://github.com/gaelcolas/Sampler/issues/279)).
