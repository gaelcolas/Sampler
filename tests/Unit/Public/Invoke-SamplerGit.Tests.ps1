...
Describe 'Invoke-SamplerGit' {
    ...
    Context 'When successfully calling git' {
        ...
        It 'Should call git with one expected argument' {
            { Sampler\Invoke-SamplerGit -Argument @('log') } | Should -Not -Throw
        ...
        It 'Should call git with two expected arguments' {
            { Sampler\Invoke-SamplerGit -Argument @('describe', '--contains') } | Should -Not -Throw
    ...
    Context 'When git returns an error' {
        ...
        It 'Should throw the correct error' {
            { Sampler\Invoke-SamplerGit -Argument @('log') } | Should -Throw -ExpectedMessage 'git returned exit code 1 indicated failure.'
    ...
    Context 'When git does not exist' {
        It 'Should throw an error' {
            { Sampler\Invoke-SamplerGit -Argument @('log') } | Should -Throw -ExpectedMessage 'git: StubNotImplemented'
        }
    }
}
